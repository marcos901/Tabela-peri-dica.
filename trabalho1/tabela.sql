...
--
-- Host: 127.0.0.1
-- Tempo de geração: 10-Jul-2019 às 19:20
...
--
-- Estrutura da tabela `elempt`
--

CREATE TABLE `elempt` (
  `AtomicNumber` int(3) DEFAULT NULL,
  `Element` varchar(13) DEFAULT NULL,
  `Symbol` varchar(3) DEFAULT NULL,
  `AtomicMass` varchar(7) DEFAULT NULL,
  `NumberofNeutrons` int(3) DEFAULT NULL,
  `NumberofProtons` int(3) DEFAULT NULL,
  `NumberofElectrons` int(3) DEFAULT NULL,
  `Period` int(1) DEFAULT NULL,
  `Group` varchar(2) DEFAULT NULL,
  `Phase` varchar(10) DEFAULT NULL,
  `Radioactive` varchar(3) DEFAULT NULL,
  `Natural` varchar(3) DEFAULT NULL,
  `Metal` varchar(3) DEFAULT NULL,
  `Nonmetal` varchar(3) DEFAULT NULL,
  `Metalloid` varchar(3) DEFAULT NULL,
  `Type` varchar(20) DEFAULT NULL,
  `AtomicRadius` varchar(4) DEFAULT NULL,
  `Electronegativity` varchar(4) DEFAULT NULL,
  `FirstIonization` varchar(7) DEFAULT NULL,
  `Density` varchar(8) DEFAULT NULL,
  `MeltingPoint` varchar(7) DEFAULT NULL,
  `BoilingPoint` varchar(6) DEFAULT NULL,
  `NumberOfIsotopes` varchar(3) DEFAULT NULL,
  `Discoverer` varchar(28) DEFAULT NULL,
  `Year` varchar(4) DEFAULT NULL,
  `SpecificHeat` varchar(6) DEFAULT NULL,
  `NumberofShells` int(1) DEFAULT NULL,
  `NumberofValence` varchar(1) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

--
-- Extraindo dados da tabela `elempt`
--

INSERT INTO `elempt` (`AtomicNumber`, `Element`, `Symbol`, `AtomicMass`, `NumberofNeutrons`, `NumberofProtons`, `NumberofElectrons`, `Period`, `Group`, `Phase`, `Radioactive`, `Natural`, `Metal`, `Nonmetal`, `Metalloid`, `Type`, `AtomicRadius`, `Electronegativity`, `FirstIonization`, `Density`, `MeltingPoint`, `BoilingPoint`, `NumberOfIsotopes`, `Discoverer`, `Year`, `SpecificHeat`, `NumberofShells`, `NumberofValence`) VALUES
...
INSERT INTO `jogadores` (`id`, `nick`, `pontos`, `nivel`) VALUES
(1, 'Marcos', 0, 'facil');
